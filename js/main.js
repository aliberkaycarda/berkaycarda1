...
document.getElementById("submitForm").addEventListener("click", function () {
  ...
  // Create JavaScript object to store data
  const formData = {
    firstName,
    lastName,
    email,
  ...
  resultsDiv.innerHTML = `
    ...
    <p><strong>Experience Rating:</strong> ${question1}</p>
    <p><strong>Visual Appeal Rating:</strong> ${question2}</p>
    <p><strong>Ease of Navigation:</strong> ${question3}</p>
    <p><strong>Recommendation Likelihood:</strong> ${question4}</p>
    <p><strong>Overall Satisfaction:</strong> ${question5}</p>
  `;

  // Calculate the average of numeric responses
  const average =
    (question1 + question2 + question3 + question4 + question5) / 5;

  // Display the average
  resultsDiv.innerHTML += `<p><strong>Average Score:</strong> ${average.toFixed(
    2
  )}</p>`;
});
